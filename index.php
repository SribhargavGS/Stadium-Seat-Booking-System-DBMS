...
<body>
  <nav class="navbar" id="navbar">
      ...
      <div class="header">
        <div class="header-content">
            <div class="header-title">
                <h1>Welcome to <span style="color: chartreuse;"><b>Stadium match booking</b></span> Online Ticketing</h1>
            </div>
    ...
    <section id="about">
        <div class="aboutus">
            <h1>About Us</h1>
            <p><b style="color:red;">Stadium Match Booking- Online Ticketing</b> is a Stadium ticket booking company. We build your trust on us and gives fast service.</p>
    ...
    <section id="contact">
        <div class="contactus">
            <h1>Contact Us</h1>
            <h2><b style="color:red;">Stadium Match Booking</b> Ticket Booking</h2>
            <p><b>Contact:</b> 020 123 45678</p>
            <p><b>Email: </b>vk@gmail.com</p>
            <p class="social-links">
                <a href="https://www.facebook.com"><i class="fa fa-facebook-square"></i></a>
                <a href="https://www.twitter.com"><i class="fa fa-twitter"></i></a>
                <a href="https://www.instagram.com/virat.kohli"><i class="fa fa-instagram"></i></a>
                <a href="https://www.linkedin.com/in"><i class="fa fa-linkedin"></i></a>
            </p>
        </div>
    ...
    <footer class="footer" id="footer">
      <div class="footer-text">
        <div class="cr-section">&copy; 2020 by <b>Stadium Match Booking</b></div>
      </div>
    </footer>
